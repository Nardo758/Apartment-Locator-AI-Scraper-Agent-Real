...
async function testFunction() {
  try {
    ...
    const testData = {
      cleanHtml:
        "<div><h1>Test Apartment Complex</h1><p>Beautiful 2 bedroom apartment for $1,500/month</p><p>Located at 123 Main Street, Atlanta, GA</p><p>Features: 2 beds, 1 bath, 900 sqft</p><p>Amenities: Pool, Gym, Parking</p><p>Special: 1 month free rent!</p></div>",
