...
To enable automated weekly scraping via GitHub Actions, you need to configure
repository secrets that contain your sensitive environment variables.
...
1. Go to your GitHub repository:
   `https://github.com/Nardo758/Apartment-Locator-AI-Scraper-Agent-Real`
...
- **Where to find:** Generate via `supabase login` or Supabase Dashboard →
...
- **Where to find:** Supabase Dashboard → Settings → Database → Connection
  string
...
- **Where to find:** Supabase Dashboard → Project Settings → General → Reference
  ID
...
- **Where to find:** [Anthropic Console](https://console.anthropic.com/) → API
  Keys
...
Then modify the workflow to use the appropriate secrets based on branch or
manual input.
