#!/usr/bin/env python3
"""
Scrape Remaining Individual Properties
Only processes individual property websites (not aggregators)
"""
...
print('\nScraping Individual Property Websites\n')
print('=' * 70)

async def get_individual_properties():
    """Get only individual property websites (exclude aggregators)"""
    ...
    # Filter to only individual properties (exclude aggregators)
    aggregators = ['apartments.com', 'rent.com', 'zillow.com', 'apartmentguide.com', 'forrent.com']
    individual_props = []
...
async def process_properties():
    ...
    if not properties:
        print('No individual properties found!')
        return
    
    print(f'\nFound {len(properties)} individual property websites\n')
