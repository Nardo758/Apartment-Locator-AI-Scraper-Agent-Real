-- Create property_sources table if it doesn't exist
-- This table stores discovered apartment property URLs and metadata
...
CREATE INDEX IF NOT EXISTS idx_property_sources_last_scraped ON public.property_sources(last_scraped_at);
...
-- Verification
SELECT 'property_sources table created successfully!' as status;
