...
import type { Database } from '../../types/supabase.ts.ts.ts';
import type { ScrapedPropertyData, FrontendProperty, ApartmentIQData } from '../types/frontend.ts.ts';
 ...
 */
export async function extractPetPolicy(
  scrapedData: ScrapedPropertyData,
): Promise<string> {
  const textFields = [
    scrapedData.free_rent_concessions,
 ...
 */
export async function extractParkingInfo(
  scrapedData: ScrapedPropertyData,
): Promise<string> {
  const textFields = [
    scrapedData.free_rent_concessions,
 ...
 */
export async function generateIqData(
  scrapedData: ScrapedPropertyData,
): Promise<ApartmentIQData> {
  try {
