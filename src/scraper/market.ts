...
export function calculateMarketVelocity(
  property: PropertyRecord,
): "hot" | "normal" | "slow" | "stale" {
  const daysOnMarket = typeof property.days_on_market === "number"
...
export function extractConcessions(
  description?: string | null,
): { concessionValue: number; concessionType: string | null } {
