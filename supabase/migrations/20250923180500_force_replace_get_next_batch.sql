-- 20250923180500_force_replace_get_next_batch.sql
-- Force drop the existing get_next_scraping_batch function so it can be recreated by subsequent migrations

DROP FUNCTION IF EXISTS public.get_next_scraping_batch(integer);
-- 20250923180500_force_replace_get_next_batch.sql
-- Forcefully drop and recreate get_next_scraping_batch with ai_model TEXT
