...
class PlaywrightInteractor {
  ...
  async robustClick(containerSelector, elementSelectors, options = {}) {
    ...
    return await this.page.evaluate(async (args) => {
      ...
      if (!globalThis.RobustElementInteractor) {
        throw new Error(
          "RobustElementInteractor not present in page context. Did you call injectInteractor()?",
        );
      }
      ...
      return await interactor.interact(
        ...
        args.elementSelectors,
        "click",
      );
    }, args);
  }

  async robustSetValue(
    containerSelector,
    elementSelectors,
    value,
    options = {},
  ...
  async robustFill(containerSelector, elementSelectors, value, options = {}) {
    return await this.robustSetValue(
      containerSelector,
      elementSelectors,
      value,
      options,
