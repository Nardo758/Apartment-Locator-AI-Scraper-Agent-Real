...
async function main() {
  ...
  try {
    if (fs.existsSync(sourcesPath)) {
      ...
      sources = [
        {
          name: `${region} Example Property A`,
          url: `https://${region}.example.com/property/a`,
          priority: "High",
        },
        {
          name: `${region} Example Property B`,
          url: `https://${region}.example.com/property/b`,
          priority: "Medium",
        },
      ];
    }
  ...
  if (dryRun) {
    console.log(
      "Dry run; not inserting into database. Sample:",
      toInsert.slice(0, 3),
    );
    process.exit(0);
  }
