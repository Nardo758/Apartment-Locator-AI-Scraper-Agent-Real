...
const urls = [
  ...
  {
    name: "Novel West Midtown Apartments",
  ...
  {
    name: "Cortland Brookhaven",
    url: "https://cortland.com/apartments/atlanta-metro/cortland-brookhaven",
  },
  {
    name: "MAA Brookhaven",
    url: "https://www.maac.com/georgia/atlanta/maa-brookhaven",
  },
  { name: "Post Brookhaven", url: "https://www.postbrookhaven.com" },
  {
    name: "The Reserve at Brookhaven",
    url: "https://www.reservebrookhaven.com",
  },
  {
    name: "MAA Milstead",
    url: "https://www.maac.com/georgia/atlanta/maa-milstead",
  },
];
...
(async () => {
  try {
    ...
    const { _data, error } = await supabase.from("scraping_queue").insert(rows)
      .select();
    if (error) {
